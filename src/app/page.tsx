  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-black' : 'bg-gradient-to-br from-gray-50 to-white'}`}>
      ...
      <HeroSection />
        ...
        {/* Footer */}
        <footer className={`py-12 px-4 sm:px-6 lg:px-8 ${isDark ? 'bg-black' : 'bg-gray-900'} text-white`}>
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4">예수서원</h3>
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-300'} mb-4`}>
              ...
              <div>
                ...
                <div className={`space-y-2 ${isDark ? 'text-gray-300' : 'text-gray-300'}`}>
              ...
              <div>
                ...
                <ul className={`space-y-2 ${isDark ? 'text-gray-300' : 'text-gray-300'}`}>
            ...
            <div className={`border-t ${isDark ? 'border-gray-800' : 'border-gray-800'} mt-8 pt-8 text-center ${isDark ? 'text-gray-400' : 'text-gray-400'}`}>
